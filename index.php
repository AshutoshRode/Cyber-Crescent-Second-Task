...
class AshuTaskPlugin
{
    ...
    {
        wp_register_script('customBlockScript', plugin_dir_url(__FILE__) . 'build/index.js', array('wp-blocks', 'wp-element', 'wp-editor'));
    ...
    {
        echo '<div id="admin-data-page"></div>';
    }
